...
PCODE_DEF(OB_HA_BLOCK_TX, 0x4B3)
PCODE_DEF(OB_HA_KILL_TX, 0x4B4)
PCODE_DEF(OB_HA_UNBLOCK_TX, 0x4B5)
...
PCODE_DEF(OB_DAS_INVALIDATE, 0x52E) //add dependency for synonym during upgrade
